    ...
    <>
      ...
      <div className="p-2 mt-5 md:mycontainer md:mt-0">
        <div className='flex items-center justify-center text-2xl font-bold cursor-pointer'>
          <img src="src/assets/Lockex2.png" alt="Lockex Logo" className="w-32 h-auto " />
        </div>
        ...
        <div className="flex flex-col p-4 items-center gap-8 text-black">
          ...
          <button
            className="flex justify-center items-center rounded-md px-7 py-3 w-fit gap-2 border bg-[#cf82eb] hover:bg-[#8D57A0] border-green-900"
